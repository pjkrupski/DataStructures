...
public class PalindromeTest {
    ...
    private boolean isPalindrome(String s) throws IllegalArgumentException{
        ...
        ArrayListStack<Character> charStack = new ArrayListStack<Character>();
        ...
        /*
        Method to build a string containing the characters in the stack.
        */


        // private String buildReverse () { result is now string in reverse
        ...
        System.out.println(inputString+" "+result);
            return inputString.equalsIgnoreCase(result.toString()); //How does 129 pass?
