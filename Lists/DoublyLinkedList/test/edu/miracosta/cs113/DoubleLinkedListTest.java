...
public class DoubleLinkedListTest {
    ...
    public void testInsertingByToString() {
        //need to delete first member of list
        buildLists(3);
    ...
    public void testIndexOfRepeats() {
        ...
        stringList.add(1, STRING_VALUES[0]); //element 0
        stringList.add(5, STRING_VALUES[0]); //element 4
    ...
    public void testIteratorConstructors() {
        ...
        try {
            ...
            fail("Test failed - creation of an iterator at index 0 of an empty list should compile. ");
        }
        ...
        try {
            ...
            fail("Test failed - creation of an iterator at beginning of list should compile.");
        }
        ...
        try {
            ...
            fail("Test failed - creation of an iterator at middle of list should compile.");
        }
        ...
        try {
            ...
            fail("Test failed - creation of an iterator at end of list should compile.");
        }
    }
