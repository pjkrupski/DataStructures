...
![Answer](doc/problemImages/HW7Tree1.png)

  - `(x * a) - y / b * (c + d)`
  
 ![Answer](doc/problemImages/HW7Tree2.png)
  
  - `(x + (a * (b - c)))/ d`
  
![Answer](doc/problemImages/HW7Tree.png)
...
![Answer](doc/problemImages/BinarySearchTree.png)
...
![](doc/problemImages/LastProblem.png)
